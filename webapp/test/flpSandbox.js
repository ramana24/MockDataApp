			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"SalesReport-display": {
								"semanticObject": "SalesReport",
								"action": "display",
								"description": "LOreial Brands Sales Report",
								"title": "Sales Report",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ux.mockdatav1",
									"url": sap.ui.require.toUrl("ux/mockdatav1")
								}
							}
						}
					}
